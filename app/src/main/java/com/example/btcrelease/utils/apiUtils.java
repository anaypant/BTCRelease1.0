package com.example.btcrelease.utils;

import androidx.annotation.NonNull;

import com.example.btcrelease.Frames.ModelNews;
import com.example.btcrelease.Frames.TrendingNews;
import com.example.btcrelease.Interfaces.apiInterface;
...
public class apiUtils {
    ...
    public static String getApiKey(){
        ...
        return apiKeys[baseUtils.getRandomNumber(0, apiKeys.length)];
